    ...
    useEffect(() => {
        if (isOpen && !hasGreeted) {
            ...
            setMessages([{
                id: "greeting",
                role: "assistant",
                content: "Hi! I'm **Jass**, your Wealthix AI financial assistant. I have access to your live account data and spending patterns. What would you like to know? (Note: This is not personalized financial advice.)",
                timestamp: new Date(),
            }]);
        }
        if (isOpen) {
