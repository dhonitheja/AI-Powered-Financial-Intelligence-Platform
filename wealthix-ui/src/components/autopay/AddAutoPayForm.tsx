        ...
        <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2">
                    <label htmlFor="paymentName" className="block text-xs font-medium text-slate-400 mb-1.5">
                        Payment Name *
                    </label>
                    <input
                        id="paymentName"
                ...
                <div>
                    <label htmlFor="amount" className="block text-xs font-medium text-slate-400 mb-1.5">Amount *</label>
                ...
                <div className="sm:col-span-2 pt-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label htmlFor="accountNumber" className="block text-xs font-medium text-slate-400 mb-1.5">
...
function ScheduleStep({
    ...
    return (
        <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label htmlFor="frequency" className="block text-xs font-medium text-slate-400 mb-1.5">Frequency *</label>
                    <select
                        id="frequency"
                        required
                ...
                <div>
                    <label htmlFor="nextDueDate" className="block text-xs font-medium text-slate-400 mb-1.5">Next Due Date *</label>
                    <input
                        id="nextDueDate"
                        type="date"
                        required
