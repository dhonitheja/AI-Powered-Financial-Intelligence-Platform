...
import { Sparkles, Loader2, Mail, ArrowRight, AlertCircle, CheckCircle } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#0D0B1E] grid-bg flex flex-col justify-center items-center p-4">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="flex flex-col items-center mb-10">
                    ...
                    <h1 className="text-4xl font-black tracking-tight gold-text">Reset Password</h1>
