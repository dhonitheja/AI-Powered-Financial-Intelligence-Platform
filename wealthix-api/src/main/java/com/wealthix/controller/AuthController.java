...
import com.wealthix.dto.LoginRequest;
import com.wealthix.dto.MessageResponse;
import com.wealthix.dto.SignupRequest;
import com.wealthix.dto.UserInfoResponse;
import com.wealthix.dto.TwoFactorSetupResponse;
import com.wealthix.dto.VerifyTwoFactorRequest;
import com.wealthix.entity.AppUser;
import com.wealthix.repository.AppUserRepository;
import com.wealthix.security.JwtUtils;
import com.wealthix.security.LoginRateLimiterService;
import com.wealthix.security.TotpAttemptService;
import com.wealthix.security.TwoFactorAuthService;
import com.wealthix.security.UserDetailsImpl;
import com.wealthix.dto.ForgotPasswordRequest;
import com.wealthix.dto.ResetPasswordRequest;
import com.wealthix.entity.PasswordResetToken;
import com.wealthix.repository.PasswordResetTokenRepository;
import com.wealthix.service.EmailService;
    ...
    public ResponseEntity<?> getCurrentUser() {
        try {
            ...
            return ResponseEntity.ok(new UserInfoResponse(
                    ...
                    userDetails.getEmail(),
                    user.isTwoFactorEnabled(),
                    null)); // No need to re-issue token on /me check if using cookies, or we could re-issue
