...
import com.wealthix.autopay.model.entity.ExecutionStatus;
 ...
 * Security invariants:
 * <ul>
 * <li>Secret key managed by {@link com.wealthix.config.StripeConfig} —
    ...
    private AutoPayExecutionLog doExecuteStripePayment(AutoPayExecutionLog execLog, AppUser user,
        ...
        try {
            ...
            execLog.setPlaidVerificationStatus(
                    com.wealthix.autopay.model.entity.PlaidVerificationStatus.UNVERIFIED);
            executionLogRepository.save(execLog);
