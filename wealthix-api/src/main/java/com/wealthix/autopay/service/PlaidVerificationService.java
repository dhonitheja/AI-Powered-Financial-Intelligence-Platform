...
import com.wealthix.autopay.model.entity.PlaidVerificationStatus;
...
public class PlaidVerificationService {
    ...
    private List<String> getAccountIds(String userId) {
        return connectionRepository.findByUserId(UUID.fromString(userId)).stream()
                .map(UserBankConnection::getPlaidAccountId)
